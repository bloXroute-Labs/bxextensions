...
PYBIND11_MAKE_OPAQUE(std::vector<service::TxFromNodeProcessingResult_t>);
...
PYBIND11_MODULE(task_pool_executor, m) {
	...
	custom_bind_vector<std::vector<service::TxFromNodeProcessingResult_t>>(m,"TxFromNodeProcessingResultList");
