...
#ifndef TPE_TASK_BTC_BLOCK_CLEANUP_SUB_TASK_H_
#define TPE_TASK_BTC_BLOCK_CLEANUP_SUB_TASK_H_

namespace task {

class BtcBlockCleanupSubTask : public SubTaskBase {

public:

    BtcBlockCleanupSubTask(
...
#endif //TPE_TASK_BTC_BLOCK_CLEANUP_SUB_TASK_H_
