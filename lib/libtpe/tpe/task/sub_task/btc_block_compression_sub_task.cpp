...
const utils::common::ByteArray& BtcBlockCompressionSubTask::output_buffer() {
	assert_execution();
	return _output_buffer;
}

const std::vector<unsigned int>& BtcBlockCompressionSubTask::short_ids() {
	assert_execution();
	return _short_ids;
}

const std::vector<unsigned int>& BtcBlockCompressionSubTask::ignored_short_ids() {
    assert_execution();
