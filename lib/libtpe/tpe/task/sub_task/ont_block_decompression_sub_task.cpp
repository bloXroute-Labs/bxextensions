...
OntBlockDecompressionSubTask::OntBlockDecompressionSubTask():
        SubTaskBase(),
        _tx_service(nullptr),
...
void OntBlockDecompressionSubTask::init(
...
OntBlockDecompressionSubTask::TaskData&
OntBlockDecompressionSubTask::task_data() {
    return _task_data;
}

void OntBlockDecompressionSubTask::_execute() {
