...
{
    PVec_t vec = hex_string_to_vec(block_message_hex_string);
    ...
    return btc_compact_block_message.get_block_sip_key();
}
...
TEST_F(BtcCompactBlockMessageTest, test_extract_sip_key)
{
    ...
    utils::crypto::SipKey_t key = compute_sip_key(compact_block_message_hex_string);
...
TEST_F(BtcCompactBlockMessageTest, test_block1)
{
    ...
    {
        vec = hex_string_to_vec(compact_short_id_hex_string);
    ...
    // Parse block
    std::string compact_block_message_hex_string = "";
    vec = hex_string_to_vec(compact_block_message_hex_string);
    BufferView_t compact_block_message(*vec);
    utils::protocols::bitcoin::BtcCompactBlockMessage btc_compact_block_message(compact_block_message);
    ...
    {
        utils::protocols::bitcoin::PCompactShortId_t compact_short_id = btc_compact_block_message.get_next_compact_short_id(offset);
        auto found = std::find(
    ...
    utils::protocols::bitcoin::PBufferView_t pre_filled_tx_bf = btc_compact_block_message.get_next_pre_filled_tx(
        offset,
        diff,
        sha,
        witness_offset
