...
#ifndef UTILS_PROTOCOLS_ONTOLOGY_CONSENSUS_CONSENSUS_ONT_MESSAGE_H_
#define UTILS_PROTOCOLS_ONTOLOGY_CONSENSUS_CONSENSUS_ONT_MESSAGE_H_
...
class ConsensusOntMessage {
public:
    explicit ConsensusOntMessage(const common::BufferView& buffer);
...
#endif //UTILS_PROTOCOLS_ONTOLOGY_CONSENSUS_CONSENSUS_ONT_MESSAGE_H_
