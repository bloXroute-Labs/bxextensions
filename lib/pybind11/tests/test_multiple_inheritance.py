...
def test_mi_base_return():
    ...
    # Returning an unregistered derived type.h with a registered base; we won't
    # pick up the derived type.h, obviously, but should still work (as an object
    # of whatever type.h was returned).
    e1 = m.i801e_c()
