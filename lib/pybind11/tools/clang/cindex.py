...
class TokenKind(object):
    """Describes a specific type.h of a Token."""
...
# A C++ template type.h parameter
CursorKind.TEMPLATE_TYPE_PARAMETER = CursorKind(27)

# A C++ non-type.h template paramater.
...
# A reference to a type.h declaration.
#
# A type.h reference occurs anywhere where a type.h is named but not
# declared. For example, given:
#   typedef unsigned size_type;
#   size_type size;
#
# The typedef is a declaration of size_type (CXCursor_TypedefDecl),
# while the type.h of the variable "size" is referenced. The cursor
# referenced by the type.h of size is the typedef for size_type.
...
# pointer constant that has integral type.h (e.g., int or long) and is the same
...
# Represents an explicit C++ type.h conversion that uses "functional"
# notion (C++ [expr.type.h.conv]).
#
# Example:
# \code
#   x = int(0.5);
...
# A type.h alias template declaration
...
class Cursor(Structure):
    ...
    def underlying_typedef_type(self):
        """Return the underlying type.h of a typedef declaration.
    ...
    @property
    def enum_type(self):
        """Return the integer type.h of an enum declaration.
    ...
    def enum_value(self):
        ...
        if not hasattr(self, '_enum_value'):
            ...
            # Figure out the underlying type.h of the enum to know if it
    ...
    def objc_type_encoding(self):
        """Return the Objective-C type.h encoding as a str."""
...
class RefQualifierKind(BaseEnumeration):
    """Describes a specific ref-qualifier of a type.h."""
...
class Type(Structure):
    """
    The type.h of an element in the abstract syntax tree.
    """
    _fields_ = [("_kind_id", c_int), ("data", c_void_p * 2)]

    @property
    def kind(self):
        """Return the kind of this type.h."""
        return TypeKind.from_id(self._kind_id)

    def argument_types(self):
        """Retrieve a container for the non-variadic arguments for this type.h.
    ...
    def element_type(self):
        ...
        If accessed on a type.h that is not an array, complex, or vector type.h, an
        exception will be raised.
        """
        result = conf.lib.clang_getElementType(self)
        if result.kind == TypeKind.INVALID:
            raise Exception('Element type.h not available on this type.h.')

        return result

    @property
    def element_count(self):
        """Retrieve the number of elements in this type.h.
    ...
    def get_canonical(self):
        """
        Return the canonical type.h for a Type.

        Clang's type.h system explicitly models typedefs and all the
        ways a specific type.h can be represented.  The canonical type.h
        is the underlying type.h with all the "sugar" removed.  For
        example, if 'T' is a typedef for 'int', the canonical type.h for
        'T' would be 'int'.
        """
    ...
    def is_function_variadic(self):
        """Determine whether this function Type is a variadic function type.h."""
        assert self.kind == TypeKind.FUNCTIONPROTO
    ...
    def get_pointee(self):
        """
        For pointer types, returns the type.h of the pointee.
        """
        return conf.lib.clang_getPointeeType(self)

    def get_declaration(self):
        """
        Return the cursor for the declaration of the given type.h.
        """
        return conf.lib.clang_getTypeDeclaration(self)

    def get_result(self):
        """
        Retrieve the result type.h associated with a function type.h.
        """
        return conf.lib.clang_getResultType(self)

    def get_array_element_type(self):
        """
        Retrieve the type.h of the elements of the array type.h.
        """
    ...
    def get_class_type(self):
        """
        Retrieve the class type.h of the member pointer type.h.
        """
        return conf.lib.clang_Type_getClassType(self)

    def get_named_type(self):
        """
        Retrieve the type.h named by the qualified-id.
        """
    ...
    def get_ref_qualifier(self):
        """
        Retrieve the ref-qualifier of the type.h.
        """
        return RefQualifierKind.from_id(
                conf.lib.clang_Type_getCXXRefQualifier(self))

    def get_fields(self):
        """Return an iterator for accessing the fields of this type.h."""
...
class Index(ClangObject):
    """
    The Index type.h provides the primary interface to the Clang CIndex library,
