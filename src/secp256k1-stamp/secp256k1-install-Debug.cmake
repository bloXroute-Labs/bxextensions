...
set(stdout_log "/Users/daniellemachpud/workspace/bloxroute-dev/bxextensions/src/secp256k1-stamp/secp256k1-install-out.log")
set(stderr_log "/Users/daniellemachpud/workspace/bloxroute-dev/bxextensions/src/secp256k1-stamp/secp256k1-install-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /Users/daniellemachpud/workspace/bloxroute-dev/bxextensions/src/secp256k1-stamp/secp256k1-install-*.log")
  endif()
  ...
  if(NOT "Unix Makefiles" MATCHES "Ninja")
    set(msg "secp256k1 install command succeeded.  See also /Users/daniellemachpud/workspace/bloxroute-dev/bxextensions/src/secp256k1-stamp/secp256k1-install-*.log")
    message(STATUS "${msg}")
  endif()
endif()
