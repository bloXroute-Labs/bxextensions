...
class TransactionService:
    ...
    def process_tx_sync_message(self, msg: InputBytes) -> bytearray: ...

    def set_sender_nonce_reuse_setting(self, age: float, gas_price_factor: float) -> None: ...
    def clear_sender_nonce(self, time: float) -> int: ...
    def eth_block_to_json(self, block: InputBytes) -> bytearray: ...
